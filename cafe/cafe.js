...
$(document).ready(function() {
        $("ul img").each(function(){
            ...
            //the hover function will be triggered when the mouse hovers over an image and will provide the img_with_info and when the mouse moves off the img it will return to the regular img without info; thats why we need two functions one is for an img with info and the other is for an img wo info
            $(this).hover(function() {
        ...
        $(this).click(function(){
           //name of item img using attribute alt
            ...
            for (var i=0;i<selectedNames.length;i++){
                htmlString += "<option>"+ "$" +selectedItems[i]+" - " + selectedNames[i] + "</option>";
            ...
            //Using a click event handler to clear order of the total and items in the order list
